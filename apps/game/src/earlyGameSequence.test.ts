...
const OPENING_DIALOGUE = {
  ...
  "prologue-cake": ["A cheap ceramic heart from a gacha machine. There's a tiny door on the side. There's a Poncho in there, somehow. MiFella thought it was the funniest thing."],
